...
<tr><td class='white' bgcolor=#3B5998>Login</td></tr></table>
...
<form method="post" action="login.php"><input type="hidden" name="PHPSESSID" value="<?PHP echo session_id(); ?>" /> 
                  ...
                  Password:<br> 
                  <input type="password" class="inputtext" name="pass" size="20"><br> 
                  <center><input type="submit" class="inputsubmit" value="login"></center> 
                  </form> 
</td>
</tr>
</table>
  ...
  <center> 
  <p><a href="../about.php?PHPSESSID=<?PHP echo session_id(); ?>">about</a>&nbsp;&nbsp;
  <a href="../contact.php?PHPSESSID=<?PHP echo session_id(); ?>">contact</a>&nbsp;&nbsp;
  <a href="../faq.php?PHPSESSID=<?PHP echo session_id(); ?>">faq</a>&nbsp;&nbsp;
