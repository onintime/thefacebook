...
<table cellspacing=0 cellpadding=2 border=0 width=95%>
	<tr>
		<td><center><b>A typical profile may look like this.<br>
			<a href="/images/preview/sample1.jpg" target="S1"><img border=0 alt="Profile Page" src="/images/preview/sample1.jpg" width="200px" height="200px"></a>
			<br><br>
		</td>
		<td><center><b>Search your friend's fridge.<br>
			<a href="/images/preview/sample2.jpg" target="S2"><img border=0 alt="Profile Page" src="/images/preview/sample2.jpg" width="200px" height="200px"></a>
			<br>
		</td>
	</tr>
	<tr>
		<td><center><b>Find your online friends.<br>
			<a href="/images/preview/sample3.jpg" target="S3"><img border=0 alt="Profile Page" src="/images/preview/sample3.jpg" width="200px" height="200px"></a>
			<br>		
		</td>
		<td><center><b>Send a message to a friend.	<br>
			<a href="/images/preview/sample4.jpg" target="S4"><img border=0 alt="Profile Page" src="/images/preview/sample4.jpg" width="200px" height="200px"></a>
			<br>	
		</td> 
	</tr>
</table>
