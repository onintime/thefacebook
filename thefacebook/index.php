...
//require_once $_SERVER["DOCUMENT_ROOT"].'/user/config/init.php';
include($_SERVER["DOCUMENT_ROOT"].'/admin/classes/classes.php');		// Include local class lib
include($_SERVER["DOCUMENT_ROOT"].'/user/config/init.php');
...
<script type="text/javascript"> var PLS_config = {ajax_url: '<?php echo Config::Get('base_url').'auth/ajax.php'; ?>',};</script>
		<script type="text/javascript" src="./user/assets/js/jquery-1.11.0.min.js"></script>
		<script type="text/javascript" src="./user/assets/js/premiumlogin.min.js"></script>
...
<table class="bordertable" cellspacing=0 cellpadding=0 border=0 width=700> 
  <tr><td> 
      ...
      <tr><td width=350 bgcolor=#3B5998> 
          ...
          <tr><td><a href='<?php echo SITE_URL; ?>'><img alt='Register' src='images/logo-right.jpg' border=0></a></td> 
